...
public class MondrianExpectation {
  ...
  public MondrianExpectation( final String query, final List<String> expectedSqls, final String result,
                           final boolean expectResultSet, final String[] columns, final boolean columnsPartial,
                           final String[] rows, final boolean partial, final int[] types ) {
    this.query = query;
  ...
  public static class Builder {
    ...
    public MondrianExpectation build() {
      return new MondrianExpectation( query, sqls, result, expectResultSet, columns, columnsPartial, rows, partial, types );
    }
